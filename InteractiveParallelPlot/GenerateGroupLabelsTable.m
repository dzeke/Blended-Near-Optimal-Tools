...
% |         Option A           |              Option B           |
    ...
    %mColorMatrix(1,:,:) = [0.6	0.06	0.06; 0.7	0.175	0.175; 0.8	0.32	0.32; 0.9	0.495	0.495; 1	0.7	0.7];
    %mColorMatrix(2,:,:) = [0.6	0.33	0.06; 0.7	0.438	0.175; 0.8	0.56	0.32; 0.9	0.697	0.495; 1	0.85	0.7];
    %mColorMatrix(3,:,:) = [0.42	0.6	0.06; 0.525	0.7	0.175; 0.64	0.8	0.32; 0.765	0.9	0.495; 0.9	1	0.7];
    %mColorMatrix(4,:,:) = [0.06	0.42	0.6; 0.175	0.525	0.7; 0.32	0.64	0.8; 0.495	0.765	0.9; 0.7	0.9	1];
    %mColorMatrix(5,:,:) = [0.15	0.06	0.6; 0.262	0.175	0.7; 0.4	0.32	0.8; 0.562	0.495	0.9;0.75	0.7	1];
   ...
   for i=1:nF %field (becomes row in the table)
        ...
        for j=1:PrimaryCounts %becomes column in table)
           ...
           for k=1:mGroupCountOrig(lRow,1)
               ...
               mDataColor(i,colCount,:)=mColorMatrix(mod(j-1,szcolor(1))+1,mod(nF-i+1,szcolor(2)),:); 
               colCount=colCount+1;
           end
